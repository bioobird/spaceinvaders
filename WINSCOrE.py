...
while running:
    ...
    if game_state == "start":
                    ...
                    for enemy in enemies[:]:
                        if bullet['rect'].colliderect(pygame.Rect(enemy['x'], enemy['y'], enemy['width'], enemy['height'])):
                            ...
                            if enemy['health'] <= 0:
                                ...
                                if enemy['enemy_type'] == 'boss5':
                                    score += 5000  # Hardcoded value for boss5
                                else:
        ...
        # Ensure proper implementation for bubble projectile removal if they move off-screen or upon collision
