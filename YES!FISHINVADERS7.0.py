...
def draw_tail(x, y, enemy_width, enemy_height, enemy_type):
    ...
    if enemy_type in ['enemy1', 'enemy2']:
        ...
        tail_color = GREEN  # Tail color for boss3
        tail_width = 90  # Width of the tail's base for boss3
        tail_height = 40  # Height from base to tip of the tail for boss3
        half_moon_radius = 20  # Radius of the "C" shape or half-moon for boss3
    elif enemy_type == 'boss4':
        tail_color = GREEN  # Tail color for boss4
        tail_width = 120  # Width of the tail's base for boss4
        tail_height = 60  # Height from base to tip of the tail for boss4
        half_moon_radius = 30  # Radius of the "C" shape or half-moon for boss4
    elif enemy_type == 'boss5':
        tail_color = GREEN  # Tail color for boss5
        tail_width = 150  # Width of the tail's base for boss5
        tail_height = 80  # Height from base to tip of the tail for boss5
        half_moon_radius = 40  # Radius of the "C" shape or half-moon for boss5
...
def update_display():
    ...
    for enemy in enemies:
        ...
        # Draw enemies as ovals instead of squares
