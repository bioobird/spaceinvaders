...
def update_display(game_state):
    if game_state == "start":
        ...
        # Draw the title
        title_text = font.render("FISH INVADERS", True, WHITE)
        ...
        window.blit(start_text, (WINDOW_WIDTH // 2 - start_text.get_width() // 2, WINDOW_HEIGHT // 2 - 25))
        ...
        window.blit(quit_text, (WINDOW_WIDTH // 2 - quit_text.get_width() // 2, WINDOW_HEIGHT // 2 + 75))
        ...
        # Load and display high scores from a file or database
        ...
        if event.type == pygame.QUIT:
            ...
            if game_state == "start":
                ...
                if start_rect.collidepoint(mouse_pos):
                    game_state = "game"
                    generate_enemies(current_stage)
                    # Reset game variables, scores, etc.
