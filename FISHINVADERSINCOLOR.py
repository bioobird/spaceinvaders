...
def update_display():
    ...
    for enemy in enemies:
        ...
        if enemy['enemy_type'] == 'enemy1':
            enemy_color = BLUE  # Change color for enemy1
        elif enemy['enemy_type'] == 'enemy2':
            enemy_color = YELLOW  # Change color for enemy2
        elif enemy['enemy_type'] == 'boss3':
            enemy_color = MAGENTA  # Change color for boss3
        elif enemy['enemy_type'] == 'boss4':
            enemy_color = LIME  # Change color for boss4
        elif enemy['enemy_type'] == 'boss5':
            enemy_color = OLIVE  # Change color for boss5
        else:
            enemy_color = RED  # Default color if enemy type is not recognized
        ...
        if enemy['is_boss']:
            if enemy['enemy_type'] == 'boss3':
                ...
                health_bar_color = CYAN  # Change health bar color for boss3
            elif enemy['enemy_type'] == 'boss4':
                max_health = boss4_health
                health_bar_color = ORANGE  # Change health bar color for boss4
            elif enemy['enemy_type'] == 'boss5':
                max_health = boss5_health
                health_bar_color = PURPLE  # Change health bar color for boss5
