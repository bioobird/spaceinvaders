...
def draw_tail(x, y, enemy_width, enemy_height):
    ...
    # Half-moon Parameters (Modify these as needed for visual effect)
    half_moon_center_x = point2[0]
    half_moon_center_y = point2[1]
    half_moon_radius = 20  # Radius of the "C" shape or half-moon
    half_moon_thickness = 5  # Thickness

    # The rectangle that bounds the circle (ellipse) from which the arc is generated
    arc_rect = [half_moon_center_x - half_moon_radius,
                half_moon_center_y - half_moon_radius,
...
def update_display():
    ...
    # Draw the spaceship, with details such as eyes and mouth
    ...
    # Draw each enemy and their respective tails
    for enemy in enemies:
        ...
        draw_tail(enemy['x'], enemy['y'], enemy['width'], enemy['height'])  # Draw the tail for all enemies
    ...
    # Update the display once all drawing is complete
    pygame.display.flip()
